exports.movies = [
    ...
    },
    {
        id: 4,
        title : "Yip Man 2",
        category : 'artsmartiaux',
        releaseYear : "2010",
        poster : "server/img/yipman.jpg",
    ...
    },
    {
        ...
        category : 'horreur',
        releaseYear : "2008",
        poster : "server/img/rec.jpg",
        directors : "Paco Plaza, Jaume BalaguerÃ³",
    ...
    },
    {
        ...
        category : 'Horreur',
        releaseYear : "2002",
        poster : "server/img/residentevil.jpg",
        directors : "Paul W.S. Anderson",
        actors : "Milla Jovovich, Eric Mabius, Michelle Rodriguez, James Purefoy, Liz May Brice",
        synopsis : "Un virus mortel s'est propagÃ© dans un laboratoire souterrain et a mis fin Ã  toute vie humaine. " +
        "Alice et Matt doivent suivre un groupe d'intervention militaire, chargÃ© de neutraliser le super-ordinateur " +
        "que l'on tient pour responsable du dÃ©sastre.",
        rate : 4,
    ...
    },
    {
        ...
        category : 'sciencesfiction',
        releaseYear : "2002",
        poster : "server/img/seigneurdesanneaux2.jpg",
        directors : "Peter Jackson",
        actors : "Elijah Wood, Sean Astin, Ian McKellen, Sala Baker, Viggo Mortensen",
        synopsis : "Frodon Sacquet, le Hobbit, doit braver de terribles dangers pour tenter de dÃ©truire " +
        "l'Anneau Unique, convoité par Sauron, le Seigneur des ténêbres. De leur côté, Gimli, Legolas et Aragorn " +
        "doivent sauver Pippin et Merry, capturÃ©s par les Orques...",
        rate : 3,
    ...
    },
    {
        ...
        category : 'sciencesfiction',
        releaseYear : "2003",
        poster : "server/img/seigneurdesanneaux3.jpg",
        directors : "Peter Jackson",
        actors : "Elijah Wood, Sean Astin, Ian McKellen, Sala Baker, Viggo Mortensen",
        synopsis : "Tandis que les ténêbres se répandent sur la Terre du Milieu, Aragorn se révèle être l'héritier " +
    ...
    },
    {
        ...
        category : 'artsmartiaux',
        releaseYear : "2005",
        poster : "server/img/crazykungfu.jpg",
        directors : "Stephen Chow",
        actors : "Stephen Chow, Wah Yuen, Leung Siu Lung, Dong Zhi Hua, Chiu Chi Ling",
        synopsis : "Sing, un prétendu gangster, doit surmonter son incapacité Ã  manier le sabre et démontrer " +
